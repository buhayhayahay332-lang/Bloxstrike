...
hbOpt:AddLabel("Team Check"):AddToggle({ Default = false, Flag = "hitbox_team_check", Callback = safeUi("Hitbox Team Check", function(v) features.hitbox:SetTeamCheck(v) end) })
...
espOpt:AddLabel("Team Check"):AddToggle({ Default = false, Flag = "esp_team_check", Callback = safeUi("ESP Team Check", function(v) features.esp:SetSetting("teamCheck", v) end) })
espOpt:AddLabel("Box"):AddToggle({ Default = false, Flag = "esp_box", Callback = safeUi("ESP Show Box", function(v) features.esp:SetSetting("showBox", v) end) })
espOpt:AddLabel("Health Bar"):AddToggle({ Default = false, Flag = "esp_health_bar", Callback = safeUi("ESP Show Health", function(v) features.esp:SetSetting("showHealth", v) end) })
espOpt:AddLabel("Names"):AddToggle({ Default = false, Flag = "esp_names", Callback = safeUi("ESP Show Name", function(v) features.esp:SetSetting("showName", v) end) })
espOpt:AddLabel("Distance"):AddToggle({ Default = false, Flag = "esp_distance", Callback = safeUi("ESP Show Distance", function(v) features.esp:SetSetting("showDistance", v) end) })
espOpt:AddLabel("Skeleton"):AddToggle({ Default = false, Flag = "esp_skeleton", Callback = safeUi("ESP Show Skeleton", function(v) features.esp:SetSetting("showSkeleton", v) end) })
espOpt:AddLabel("Tracers"):AddToggle({ Default = false, Flag = "esp_tracers", Callback = safeUi("ESP Show Tracers", function(v) features.esp:SetSetting("showTracers", v) end) })
espOpt:AddLabel("Weapon"):AddToggle({ Default = false, Flag = "esp_weapon", Callback = safeUi("ESP Show Weapon", function(v) features.esp:SetSetting("showWeapon", v) end) })
espOpt:AddLabel("Money"):AddToggle({ Default = false, Flag = "esp_money", Callback = safeUi("ESP Show Money", function(v) features.esp:SetSetting("showMoney", v) end) })
espOpt:AddLabel("Flags"):AddToggle({ Default = false, Flag = "esp_flags", Callback = safeUi("ESP Show Flags", function(v) features.esp:SetSetting("showFlags", v) end) })
espOpt:AddLabel("Chams Overlays"):AddToggle({ Default = false, Flag = "esp_chams", Callback = safeUi("ESP Show Chams", function(v) features.esp:SetSetting("showChams", v) end) })
...
pcOpt:AddLabel("Team Check"):AddToggle({ Default = false, Flag = "chams_player_team_check", Callback = safeUi("Player Chams Team Check", function(v) features.chams:SetSetting("playerTeamCheck", v) end) })
pcOpt:AddLabel("Visible Only"):AddToggle({ Default = false, Flag = "chams_player_visible_only", Callback = safeUi("Player Chams Visible Only", function(v) features.chams:SetSetting("playerVisibleOnly", v) end) })
pcOpt:AddLabel("Color"):AddColorPicker({ Default = Color3.fromRGB(255, 0, 0), Flag = "chams_player_color", Callback = safeUi("Player Chams Color", function(v) features.chams:SetSetting("playerColor", v) end) })
...
wcOpt:AddLabel("Color"):AddColorPicker({ Default = Color3.fromRGB(0, 255, 255), Flag = "chams_weapon_color", Callback = safeUi("Weapon Chams Color", function(v) features.chams:SetSetting("weaponColor", v) end) })
...
keOpt:AddLabel("Color"):AddColorPicker({ Default = Color3.fromRGB(255, 0, 100), Flag = "killfx_color", Callback = safeUi("Kill Effect Color", function(v) features.killEffects:SetSetting("color", v) end) })

...
window:addToggle("ESP Show Box", true, safeUi("ESP Show Box", function(value)
    features.esp:SetSetting("showBox", value)
end))
window:addToggle("ESP Show Health", true, safeUi("ESP Show Health", function(value)
    features.esp:SetSetting("showHealth", value)
end))
window:addToggle("ESP Show Name", true, safeUi("ESP Show Name", function(value)
    features.esp:SetSetting("showName", value)
end))
window:addToggle("ESP Show Distance", true, safeUi("ESP Show Distance", function(value)
...
window:addColorPicker("ESP Box Color", Color3.fromRGB(255, 50, 50), safeUi("ESP Box Color", function(value)
...
window:addColorPicker("ESP Tracer Color", Color3.fromRGB(255, 50, 50), safeUi("ESP Tracer Color", function(value)
...
window:addColorPicker("Player Chams Color", Color3.fromRGB(255, 0, 255), safeUi("Player Chams Color", function(value)
